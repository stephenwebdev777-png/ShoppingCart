...
const mockContext = {
  all_product: [{ id: 1, name: "Premium Jacket", new_price: 100, image: "img.jpg" }],
...
describe('CartItem Component', () => {
  ...
  test('calls removeFromCart with the correct key when delete icon is clicked', () => {
    ...
    // FIX 4: Expect the call with "1_S" (the key), not just 1
  ...
  test('shows alert if checkout is clicked without auth token', () => {
    ...
    expect(window.alert).toHaveBeenCalledWith("Please login to proceed to checkout.");
  });
});